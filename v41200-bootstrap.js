...
(()=>{
  ...
  window.KEYSUITE_BUILD='V4.26.02';
  const VERSION='42602';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.26.02';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.26.02':'V4.26.02'});document.documentElement.setAttribute('data-keysuite-version','4.26.02')}catch(_){} }
  (async()=>{
