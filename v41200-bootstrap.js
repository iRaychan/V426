...
(()=>{
  ...
  window.KEYSUITE_BUILD='V4.26.07';
  const VERSION='42607';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.26.07';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.26.07':'V4.26.07'});document.documentElement.setAttribute('data-keysuite-version','4.26.07')}catch(_){} }
  (async()=>{
