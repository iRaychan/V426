...
(()=>{
  ...
  window.KEYSUITE_BUILD='V4.26.03';
  const VERSION='42603';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.26.03';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.26.03':'V4.26.03'});document.documentElement.setAttribute('data-keysuite-version','4.26.03')}catch(_){} }
  (async()=>{
