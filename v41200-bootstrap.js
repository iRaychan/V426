...
(()=>{
  ...
  window.KEYSUITE_BUILD='V4.26.01';
  const VERSION='42601';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.26.01';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.26.01':'V4.26.01'});document.documentElement.setAttribute('data-keysuite-version','4.26.01')}catch(_){} }
  (async()=>{
